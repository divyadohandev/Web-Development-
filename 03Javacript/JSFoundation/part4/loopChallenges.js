...
/* 
2. Write a `While` loop that counts dowm from 5 to 1 and stores the numbers in an array named `countdown`.
*/
...
/* 
6. Write a `for` loop that list all the cities in the array `["Paris", "New York", "Tokyo", "London"]`
